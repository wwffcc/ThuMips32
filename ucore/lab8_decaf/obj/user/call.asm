...
obj/__user_call.out:     file format elf32-tradlittlemips
...
main:                                   # function entry
          subu $sp, $sp, 4              
  803280:	27bdfffc afbe0000 afbffffc 03a0f021     ...'........!...
          sw $fp, 0($sp)                
          sw $ra, -4($sp)               
          move $fp, $sp                 
          addiu $sp, $sp, -44           
  803290:	27bdffd4 afc40004 afc50008 afc6000c     ...'............
          sw $a0, 4($fp)                
          sw $a1, 8($fp)                
          sw $a2, 12($fp)               
          sw $a3, 16($fp)               
...
_L13:                                   
  ...
  8032a8:	25084030 	addiu	t0,t0,16432
          li      $t0, 3                
  8032ac:	24080003 	li	t0,3
          li      $t1, 4                
  8032b0:	24090004 	li	t1,4
          li      $t2, 5                
  8032b4:	240a0005 	li	t2,5
          li      $t3, 6                
  8032b8:	240b0006 	li	t3,6
          li      $t4, 7                
  8032bc:	240c0007 	li	t4,7
          move    $a0, $t0              
  8032c0:	01002021 	move	a0,t0
          move    $a1, $t1              
  8032c4:	01202821 	move	a1,t1
          move    $a2, $t2              
  8032c8:	01403021 	move	a2,t2
          move    $a3, $t3              
  8032cc:	01603821 	move	a3,t3
          sw      $t4, 16($sp)          
  8032d0:	afac0010 	sw	t4,16(sp)
          jal     _test                 
  8032d4:	0c200cbe 	jal	8032f8 <_test>
  8032d8:	00000000 	nop
          move    $v0, $zero            
  8032dc:	00001021 	move	v0,zero
          move    $sp, $fp              
  8032e0:	03c0e821 	move	sp,s8
          lw      $ra, -4($fp)          
  8032e4:	8fdffffc 	lw	ra,-4(s8)
          lw      $fp, 0($fp)           
  8032e8:	8fde0000 	lw	s8,0(s8)
          addu    $sp, $sp, 4           
  8032ec:	27bd0004 	addiu	sp,sp,4
          jr      $ra                   
  8032f0:	03e00008 	jr	ra
  8032f4:	00000000 	nop
...
_test:                                  # function entry
          subu $sp, $sp, 4              
  8032f8:	27bdfffc 	addiu	sp,sp,-4
          sw $fp, 0($sp)                
  8032fc:	afbe0000 	sw	s8,0(sp)
          sw $ra, -4($sp)               
  803300:	afbffffc 	sw	ra,-4(sp)
          move $fp, $sp                 
  803304:	03a0f021 	move	s8,sp
          addiu $sp, $sp, -28           
  803308:	27bdffe4 	addiu	sp,sp,-28
          sw $a0, 4($fp)                
  80330c:	afc40004 	sw	a0,4(s8)
          sw $a1, 8($fp)                
  803310:	afc50008 	sw	a1,8(s8)
          sw $a2, 12($fp)               
  803314:	afc6000c 	sw	a2,12(s8)
          sw $a3, 16($fp)               
  803318:	afc70010 	sw	a3,16(s8)

0080331c <_L14>:
_L14:                                   
          la      $t0, _global_addr     
  80331c:	3c080080 	lui	t0,0x80
  803320:	25084030 	addiu	t0,t0,16432
          lw      $t0, 4($fp)           
  803324:	8fc80004 	lw	t0,4(s8)
          move    $a0, $t0              
  803328:	01002021 	move	a0,t0
          sw      $t0, 4($fp)           
  80332c:	afc80004 	sw	t0,4(s8)
          jal     _PrintInt             
  803330:	0c2001b6 	jal	8006d8 <_PrintInt>
  803334:	00000000 	nop
          lw      $t0, 4($fp)           
  803338:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  80333c:	8fc90008 	lw	t1,8(s8)
          move    $a0, $t1              
  803340:	01202021 	move	a0,t1
          sw      $t0, 4($fp)           
  803344:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  803348:	afc90008 	sw	t1,8(s8)
          jal     _PrintInt             
  80334c:	0c2001b6 	jal	8006d8 <_PrintInt>
  803350:	00000000 	nop
          lw      $t0, 4($fp)           
  803354:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  803358:	8fc90008 	lw	t1,8(s8)
          lw      $t2, 12($fp)          
  80335c:	8fca000c 	lw	t2,12(s8)
          move    $a0, $t2              
  803360:	01402021 	move	a0,t2
          sw      $t0, 4($fp)           
  803364:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  803368:	afc90008 	sw	t1,8(s8)
          sw      $t2, 12($fp)          
  80336c:	afca000c 	sw	t2,12(s8)
          jal     _PrintInt             
  803370:	0c2001b6 	jal	8006d8 <_PrintInt>
  803374:	00000000 	nop
          lw      $t0, 4($fp)           
  803378:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  80337c:	8fc90008 	lw	t1,8(s8)
          lw      $t2, 12($fp)          
  803380:	8fca000c 	lw	t2,12(s8)
          lw      $t3, 16($fp)          
  803384:	8fcb0010 	lw	t3,16(s8)
          move    $a0, $t3              
  803388:	01602021 	move	a0,t3
          sw      $t0, 4($fp)           
  80338c:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  803390:	afc90008 	sw	t1,8(s8)
          sw      $t2, 12($fp)          
  803394:	afca000c 	sw	t2,12(s8)
          sw      $t3, 16($fp)          
  803398:	afcb0010 	sw	t3,16(s8)
          jal     _PrintInt             
  80339c:	0c2001b6 	jal	8006d8 <_PrintInt>
  8033a0:	00000000 	nop
          lw      $t0, 4($fp)           
  8033a4:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  8033a8:	8fc90008 	lw	t1,8(s8)
          lw      $t2, 12($fp)          
  8033ac:	8fca000c 	lw	t2,12(s8)
          lw      $t3, 16($fp)          
  8033b0:	8fcb0010 	lw	t3,16(s8)
          lw      $t4, 20($fp)          
  8033b4:	8fcc0014 	lw	t4,20(s8)
          move    $a0, $t4              
  8033b8:	01802021 	move	a0,t4
          sw      $t0, 4($fp)           
  8033bc:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  8033c0:	afc90008 	sw	t1,8(s8)
          sw      $t2, 12($fp)          
  8033c4:	afca000c 	sw	t2,12(s8)
          sw      $t3, 16($fp)          
  8033c8:	afcb0010 	sw	t3,16(s8)
          sw      $t4, 20($fp)          
  8033cc:	afcc0014 	sw	t4,20(s8)
          jal     _PrintInt             
  8033d0:	0c2001b6 	jal	8006d8 <_PrintInt>
  8033d4:	00000000 	nop
          lw      $t0, 4($fp)           
  8033d8:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  8033dc:	8fc90008 	lw	t1,8(s8)
          lw      $t2, 12($fp)          
  8033e0:	8fca000c 	lw	t2,12(s8)
          lw      $t3, 16($fp)          
  8033e4:	8fcb0010 	lw	t3,16(s8)
          lw      $t4, 20($fp)          
  8033e8:	8fcc0014 	lw	t4,20(s8)
          sw      $t0, 4($fp)           
  8033ec:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  8033f0:	afc90008 	sw	t1,8(s8)
          sw      $t2, 12($fp)          
  8033f4:	afca000c 	sw	t2,12(s8)
          sw      $t3, 16($fp)          
  8033f8:	afcb0010 	sw	t3,16(s8)
          sw      $t4, 20($fp)          
  8033fc:	afcc0014 	sw	t4,20(s8)
          move    $v0, $zero            
  803400:	00001021 	move	v0,zero
          move    $sp, $fp              
  803404:	03c0e821 	move	sp,s8
          lw      $ra, -4($fp)          
  803408:	8fdffffc 	lw	ra,-4(s8)
          lw      $fp, 0($fp)           
  80340c:	8fde0000 	lw	s8,0(s8)
          addu    $sp, $sp, 4           
  803410:	27bd0004 	addiu	sp,sp,4
          jr      $ra                   
