...
obj/__user_spin.out:     file format elf32-tradlittlemips
...
main(void) {
  ...
  803294:	244438d0 	addiu	a0,v0,14544
  ...
  8032b0:	14400007 	bnez	v0,8032d0 <main+0x50>
  8032b4:	00000000 	nop
        cprintf("I am the child. spinning ...\n");
  8032b8:	3c020080 	lui	v0,0x80
  8032bc:	244438f8 	addiu	a0,v0,14584
  8032c0:	0c2002bd 	jal	800af4 <cprintf>
  8032c4:	00000000 	nop
        while (1);
  8032c8:	08200cb2 	j	8032c8 <main+0x48>
  8032cc:	00000000 	nop
    }
    cprintf("I am the parent. Running the child...\n");
  8032d0:	3c020080 	lui	v0,0x80
  8032d4:	24443918 	addiu	a0,v0,14616
  8032d8:	0c2002bd 	jal	800af4 <cprintf>
  8032dc:	00000000 	nop
  ...
  8032f8:	3c020080 	lui	v0,0x80
  8032fc:	24443940 	addiu	a0,v0,14656
  803300:	0c2002bd 	jal	800af4 <cprintf>
  803304:	00000000 	nop

    assert((ret = kill(pid)) == 0);
  803308:	8fc40018 	lw	a0,24(s8)
  80330c:	0c2005a4 	jal	801690 <kill>
  803310:	00000000 	nop
  803314:	afc2001c 	sw	v0,28(s8)
  803318:	8fc2001c 	lw	v0,28(s8)
  80331c:	1040000a 	beqz	v0,803348 <main+0xc8>
  803320:	00000000 	nop
  803324:	3c020080 	lui	v0,0x80
  803328:	24443968 	addiu	a0,v0,14696
  80332c:	24050014 	li	a1,20
  803330:	3c020080 	lui	v0,0x80
  803334:	24463974 	addiu	a2,v0,14708
  803338:	3c020080 	lui	v0,0x80
  80333c:	2447398c 	addiu	a3,v0,14732
  803340:	0c200254 	jal	800950 <__panic>
  803344:	00000000 	nop
    cprintf("kill returns %d\n", ret);
  803348:	3c020080 	lui	v0,0x80
  80334c:	244439a4 	addiu	a0,v0,14756
  803350:	8fc5001c 	lw	a1,28(s8)
  803354:	0c2002bd 	jal	800af4 <cprintf>
  803358:	00000000 	nop

    assert((ret = waitpid(pid, NULL)) == 0);
  80335c:	8fc40018 	lw	a0,24(s8)
  803360:	00002821 	move	a1,zero
  803364:	0c200588 	jal	801620 <waitpid>
  803368:	00000000 	nop
  80336c:	afc2001c 	sw	v0,28(s8)
  803370:	8fc2001c 	lw	v0,28(s8)
  803374:	1040000a 	beqz	v0,8033a0 <main+0x120>
  803378:	00000000 	nop
  80337c:	3c020080 	lui	v0,0x80
  803380:	24443968 	addiu	a0,v0,14696
  803384:	24050017 	li	a1,23
  803388:	3c020080 	lui	v0,0x80
  80338c:	24463974 	addiu	a2,v0,14708
  803390:	3c020080 	lui	v0,0x80
  803394:	244739b8 	addiu	a3,v0,14776
  803398:	0c200254 	jal	800950 <__panic>
  80339c:	00000000 	nop
    cprintf("wait returns %d\n", ret);
  8033a0:	3c020080 	lui	v0,0x80
  8033a4:	244439d8 	addiu	a0,v0,14808
  8033a8:	8fc5001c 	lw	a1,28(s8)
  8033ac:	0c2002bd 	jal	800af4 <cprintf>
  8033b0:	00000000 	nop

    cprintf("spin may pass.\n");
  8033b4:	3c020080 	lui	v0,0x80
  8033b8:	244439ec 	addiu	a0,v0,14828
  ...
  8033cc:	8fbf0024 	lw	ra,36(sp)
  8033d0:	8fbe0020 	lw	s8,32(sp)
  8033d4:	27bd0028 	addiu	sp,sp,40
