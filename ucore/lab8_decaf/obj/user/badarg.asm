...
obj/__user_badarg.out:     file format elf32-tradlittlemips
...
main(void) {
  ...
  80328c:	03a0f021 	move	s8,sp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  803290:	0c20056e 	jal	8015b8 <fork>
  803294:	00000000 	nop
  803298:	afc2001c 	sw	v0,28(s8)
  80329c:	8fc2001c 	lw	v0,28(s8)
  8032a0:	14400014 	bnez	v0,8032f4 <main+0x74>
  8032a4:	00000000 	nop
        cprintf("fork ok.\n");
  8032a8:	3c020080 	lui	v0,0x80
  8032ac:	24443910 	addiu	a0,v0,14608
  8032b0:	0c2002bd 	jal	800af4 <cprintf>
  8032b4:	00000000 	nop
        int i;
        for (i = 0; i < 10; i ++) {
  8032b8:	afc00018 	sw	zero,24(s8)
  8032bc:	08200cb6 	j	8032d8 <main+0x58>
  8032c0:	00000000 	nop
            yield();
  8032c4:	0c200598 	jal	801660 <yield>
  8032c8:	00000000 	nop
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        ...
        int i;
        for (i = 0; i < 10; i ++) {
  8032cc:	8fc20018 	lw	v0,24(s8)
  8032d0:	24420001 	addiu	v0,v0,1
  8032d4:	afc20018 	sw	v0,24(s8)
  8032d8:	8fc20018 	lw	v0,24(s8)
  8032dc:	2842000a 	slti	v0,v0,10
  8032e0:	1440fff8 	bnez	v0,8032c4 <main+0x44>
  8032e4:	00000000 	nop
            yield();
        }
        exit(0xbeaf);
  8032e8:	3404beaf 	li	a0,0xbeaf
  8032ec:	0c200560 	jal	801580 <exit>
  8032f0:	00000000 	nop
    }
    assert(pid > 0);
  8032f4:	8fc2001c 	lw	v0,28(s8)
  8032f8:	1c40000a 	bgtz	v0,803324 <main+0xa4>
  8032fc:	00000000 	nop
  803300:	3c020080 	lui	v0,0x80
  803304:	2444391c 	addiu	a0,v0,14620
  803308:	2405000f 	li	a1,15
  80330c:	3c020080 	lui	v0,0x80
  803310:	2446392c 	addiu	a2,v0,14636
  803314:	3c020080 	lui	v0,0x80
  803318:	24473944 	addiu	a3,v0,14660
  80331c:	0c200254 	jal	800950 <__panic>
  803320:	00000000 	nop
    assert(waitpid(-1, NULL) != 0);
  803324:	2404ffff 	li	a0,-1
  803328:	00002821 	move	a1,zero
  80332c:	0c200588 	jal	801620 <waitpid>
  803330:	00000000 	nop
  803334:	1440000a 	bnez	v0,803360 <main+0xe0>
  803338:	00000000 	nop
  80333c:	3c020080 	lui	v0,0x80
  803340:	2444391c 	addiu	a0,v0,14620
  803344:	24050010 	li	a1,16
  803348:	3c020080 	lui	v0,0x80
  80334c:	2446392c 	addiu	a2,v0,14636
  803350:	3c020080 	lui	v0,0x80
  803354:	2447394c 	addiu	a3,v0,14668
  803358:	0c200254 	jal	800950 <__panic>
  80335c:	00000000 	nop
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  803360:	8fc4001c 	lw	a0,28(s8)
  803364:	3c05c000 	lui	a1,0xc000
  803368:	0c200588 	jal	801620 <waitpid>
  80336c:	00000000 	nop
  803370:	1440000a 	bnez	v0,80339c <main+0x11c>
  803374:	00000000 	nop
  803378:	3c020080 	lui	v0,0x80
  80337c:	2444391c 	addiu	a0,v0,14620
  803380:	24050011 	li	a1,17
  803384:	3c020080 	lui	v0,0x80
  803388:	2446392c 	addiu	a2,v0,14636
  80338c:	3c020080 	lui	v0,0x80
  803390:	24473964 	addiu	a3,v0,14692
  803394:	0c200254 	jal	800950 <__panic>
  803398:	00000000 	nop
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  80339c:	27c20020 	addiu	v0,s8,32
  8033a0:	8fc4001c 	lw	a0,28(s8)
  8033a4:	00402821 	move	a1,v0
  8033a8:	0c200588 	jal	801620 <waitpid>
  8033ac:	00000000 	nop
  8033b0:	14400005 	bnez	v0,8033c8 <main+0x148>
  8033b4:	00000000 	nop
  8033b8:	8fc30020 	lw	v1,32(s8)
  8033bc:	3402beaf 	li	v0,0xbeaf
  8033c0:	1062000a 	beq	v1,v0,8033ec <main+0x16c>
  8033c4:	00000000 	nop
  8033c8:	3c020080 	lui	v0,0x80
  8033cc:	2444391c 	addiu	a0,v0,14620
  8033d0:	24050012 	li	a1,18
  8033d4:	3c020080 	lui	v0,0x80
  8033d8:	2446392c 	addiu	a2,v0,14636
  8033dc:	3c020080 	lui	v0,0x80
  8033e0:	2447398c 	addiu	a3,v0,14732
  8033e4:	0c200254 	jal	800950 <__panic>
  8033e8:	00000000 	nop
    cprintf("badarg pass.\n");
  8033ec:	3c020080 	lui	v0,0x80
  8033f0:	244439c4 	addiu	a0,v0,14788
  8033f4:	0c2002bd 	jal	800af4 <cprintf>
  8033f8:	00000000 	nop
    return 0;
  8033fc:	00001021 	move	v0,zero
}
  803400:	03c0e821 	move	sp,s8
  803404:	8fbf002c 	lw	ra,44(sp)
  803408:	8fbe0028 	lw	s8,40(sp)
  80340c:	27bd0030 	addiu	sp,sp,48
  803410:	03e00008 	jr	ra
  803414:	00000000 	nop
	...
