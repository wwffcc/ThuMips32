...
obj/__user_yield.out:     file format elf32-tradlittlemips
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8004ec:	24443350 	addiu	a0,v0,13136
  ...
  800510:	2464335c 	addiu	a0,v1,13148
  ...
  80052c:	24643370 	addiu	a0,v1,13168
  ...
  800548:	24643384 	addiu	a0,v1,13188
  ...
  800564:	24643398 	addiu	a0,v1,13208
...
void _PrintInt(int x) {
  ...
  8006f0:	244433b0 	addiu	a0,v0,13232
...
void _PrintChar(char x) {
  ...
  800738:	246433b4 	addiu	a0,v1,13236
...
void _PrintString(const char* x) {
  ...
  800778:	244433b8 	addiu	a0,v0,13240
...
void _PrintBool(bool x) {
  ...
  8007c4:	244433bc 	addiu	a0,v0,13244
  ...
  8007dc:	244433c4 	addiu	a0,v0,13252
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80097c:	244433d0 	addiu	a0,v0,13264
  ...
  8009a8:	244433ec 	addiu	a0,v0,13292
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8009ec:	244433f0 	addiu	a0,v0,13296
  ...
  800a18:	244433ec 	addiu	a0,v0,13292
...
readline(const char *prompt) {
  ...
  800d3c:	24453410 	addiu	a1,v0,13328
  ...
  800e0c:	24653414 	addiu	a1,v1,13332
  ...
  800e6c:	24653414 	addiu	a1,v1,13332
  ...
  800ebc:	24653414 	addiu	a1,v1,13332
...
exit(int error_code) {
  ...
  8015a4:	24443420 	addiu	a0,v0,13344
...
umain(int argc, char *argv[]) {
  ...
  801940:	24453440 	addiu	a1,v0,13376
  ...
  801964:	24443448 	addiu	a0,v0,13384
  801968:	2405001a 	li	a1,26
  80196c:	3c020080 	lui	v0,0x80
  801970:	2446345c 	addiu	a2,v0,13404
  ...
  801988:	24453478 	addiu	a1,v0,13432
  ...
  8019ac:	24443448 	addiu	a0,v0,13384
  8019b0:	2405001d 	li	a1,29
  8019b4:	3c020080 	lui	v0,0x80
  8019b8:	24463480 	addiu	a2,v0,13440
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  801d74:	244336b0 	addiu	v1,v0,14000
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  802088:	244236dc 	addiu	v0,v0,14044
  ...
  80220c:	2442364c 	addiu	v0,v0,13900
  ...
  802234:	244736c4 	addiu	a3,v0,14020
  ...
  80225c:	244736d0 	addiu	a3,v0,14032
  ...
  80228c:	245136d4 	addiu	s1,v0,14036
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  803290:	0c2005b2 	jal	8016c8 <getpid>
  803294:	00000000 	nop
  803298:	3c030080 	lui	v1,0x80
  80329c:	24643840 	addiu	a0,v1,14400
  8032a0:	00402821 	move	a1,v0
  8032a4:	0c2002bd 	jal	800af4 <cprintf>
  8032a8:	00000000 	nop
    for (i = 0; i < 5; i ++) {
  8032ac:	afc00018 	sw	zero,24(s8)
  8032b0:	08200cbb 	j	8032ec <main+0x6c>
  8032b4:	00000000 	nop
        yield();
  8032b8:	0c200598 	jal	801660 <yield>
  8032bc:	00000000 	nop
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  8032c0:	0c2005b2 	jal	8016c8 <getpid>
  8032c4:	00000000 	nop
  8032c8:	3c030080 	lui	v1,0x80
  8032cc:	2464385c 	addiu	a0,v1,14428
  8032d0:	00402821 	move	a1,v0
  8032d4:	8fc60018 	lw	a2,24(s8)
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  8032e0:	8fc20018 	lw	v0,24(s8)
  8032e4:	24420001 	addiu	v0,v0,1
  8032e8:	afc20018 	sw	v0,24(s8)
  8032ec:	8fc20018 	lw	v0,24(s8)
  8032f0:	28420005 	slti	v0,v0,5
  8032f4:	1440fff0 	bnez	v0,8032b8 <main+0x38>
  8032f8:	00000000 	nop
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  8032fc:	0c2005b2 	jal	8016c8 <getpid>
  803300:	00000000 	nop
  803304:	3c030080 	lui	v1,0x80
  803308:	24643880 	addiu	a0,v1,14464
  80330c:	00402821 	move	a1,v0
  803310:	0c2002bd 	jal	800af4 <cprintf>
  803314:	00000000 	nop
    cprintf("yield pass.\n");
  803318:	3c020080 	lui	v0,0x80
  80331c:	2444389c 	addiu	a0,v0,14492
  803320:	0c2002bd 	jal	800af4 <cprintf>
  803324:	00000000 	nop
    return 0;
  803328:	00001021 	move	v0,zero
}
  80332c:	03c0e821 	move	sp,s8
  803330:	8fbf0024 	lw	ra,36(sp)
  803334:	8fbe0020 	lw	s8,32(sp)
  803338:	27bd0028 	addiu	sp,sp,40
  80333c:	03e00008 	jr	ra
  803340:	00000000 	nop
	...
