...
obj/__user_sleep.out:     file format elf32-tradlittlemips
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8004ec:	244433e0 	addiu	a0,v0,13280
  ...
  800510:	246433ec 	addiu	a0,v1,13292
  ...
  80052c:	24643400 	addiu	a0,v1,13312
  ...
  800548:	24643414 	addiu	a0,v1,13332
  ...
  800564:	24643428 	addiu	a0,v1,13352
...
void _PrintInt(int x) {
  ...
  8006f0:	24443440 	addiu	a0,v0,13376
...
void _PrintChar(char x) {
  ...
  800738:	24643444 	addiu	a0,v1,13380
...
void _PrintString(const char* x) {
  ...
  800778:	24443448 	addiu	a0,v0,13384
...
void _PrintBool(bool x) {
  ...
  8007c4:	2444344c 	addiu	a0,v0,13388
  ...
  8007dc:	24443454 	addiu	a0,v0,13396
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80097c:	24443460 	addiu	a0,v0,13408
  ...
  8009a8:	2444347c 	addiu	a0,v0,13436
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8009ec:	24443480 	addiu	a0,v0,13440
  ...
  800a18:	2444347c 	addiu	a0,v0,13436
...
readline(const char *prompt) {
  ...
  800d3c:	244534a0 	addiu	a1,v0,13472
  ...
  800e0c:	246534a4 	addiu	a1,v1,13476
  ...
  800e6c:	246534a4 	addiu	a1,v1,13476
  ...
  800ebc:	246534a4 	addiu	a1,v1,13476
...
exit(int error_code) {
  ...
  8015a4:	244434b0 	addiu	a0,v0,13488
...
umain(int argc, char *argv[]) {
  ...
  801940:	244534d0 	addiu	a1,v0,13520
  ...
  801964:	244434d8 	addiu	a0,v0,13528
  801968:	2405001a 	li	a1,26
  80196c:	3c020080 	lui	v0,0x80
  801970:	244634ec 	addiu	a2,v0,13548
  ...
  801988:	24453508 	addiu	a1,v0,13576
  ...
  8019ac:	244434d8 	addiu	a0,v0,13528
  8019b0:	2405001d 	li	a1,29
  8019b4:	3c020080 	lui	v0,0x80
  8019b8:	24463510 	addiu	a2,v0,13584
  ...
  8019d0:	0c200cc0 	jal	803300 <main>
  8019d4:	00000000 	nop
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  801d74:	24433740 	addiu	v1,v0,14144
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  802088:	2442376c 	addiu	v0,v0,14188
  ...
  80220c:	244236dc 	addiu	v0,v0,14044
  ...
  802234:	24473754 	addiu	a3,v0,14164
  ...
  80225c:	24473760 	addiu	a3,v0,14176
  ...
  80228c:	24513764 	addiu	s1,v0,14180
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  803290:	afc40028 	sw	a0,40(s8)
    int i, time = 100;
  803294:	24020064 	li	v0,100
  803298:	afc2001c 	sw	v0,28(s8)
    for (i = 0; i < 10; i ++) {
  80329c:	afc00018 	sw	zero,24(s8)
  8032a0:	08200cb9 	j	8032e4 <sleepy+0x64>
  8032a4:	00000000 	nop
        sleep(time);
  8032a8:	8fc2001c 	lw	v0,28(s8)
  8032ac:	00402021 	move	a0,v0
  8032b0:	0c2005d8 	jal	801760 <sleep>
  8032b4:	00000000 	nop
        cprintf("sleep %d x %d slices.\n", i + 1, time);
  8032b8:	8fc20018 	lw	v0,24(s8)
  8032bc:	24420001 	addiu	v0,v0,1
  8032c0:	3c030080 	lui	v1,0x80
  8032c4:	246438d0 	addiu	a0,v1,14544
  8032c8:	00402821 	move	a1,v0
  8032cc:	8fc6001c 	lw	a2,28(s8)
  8032d0:	0c2002bd 	jal	800af4 <cprintf>
  8032d4:	00000000 	nop
#include <ulib.h>
...
sleepy(int pid) {
  ...
  8032dc:	24420001 	addiu	v0,v0,1
  8032e0:	afc20018 	sw	v0,24(s8)
  8032e4:	8fc20018 	lw	v0,24(s8)
  8032e8:	2842000a 	slti	v0,v0,10
  8032ec:	1440ffee 	bnez	v0,8032a8 <sleepy+0x28>
  8032f0:	00000000 	nop
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  8032f4:	00002021 	move	a0,zero
  8032f8:	0c200560 	jal	801580 <exit>
  8032fc:	00000000 	nop
...
int
main(void) {
  803300:	27bdffd0 	addiu	sp,sp,-48
  803304:	afbf002c 	sw	ra,44(sp)
  803308:	afbe0028 	sw	s8,40(sp)
  80330c:	03a0f021 	move	s8,sp
    unsigned int time = gettime_msec();
  803310:	0c2005e6 	jal	801798 <gettime_msec>
  803314:	00000000 	nop
  803318:	afc20018 	sw	v0,24(s8)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  80331c:	0c20056e 	jal	8015b8 <fork>
  803320:	00000000 	nop
  803324:	afc2001c 	sw	v0,28(s8)
  803328:	8fc2001c 	lw	v0,28(s8)
  80332c:	14400004 	bnez	v0,803340 <main+0x40>
  803330:	00000000 	nop
        sleepy(pid1);
  803334:	8fc4001c 	lw	a0,28(s8)
  803338:	0c200ca0 	jal	803280 <sleepy>
  80333c:	00000000 	nop
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  803340:	27c20020 	addiu	v0,s8,32
  803344:	8fc4001c 	lw	a0,28(s8)
  803348:	00402821 	move	a1,v0
  80334c:	0c200588 	jal	801620 <waitpid>
  803350:	00000000 	nop
  803354:	14400004 	bnez	v0,803368 <main+0x68>
  803358:	00000000 	nop
  80335c:	8fc20020 	lw	v0,32(s8)
  803360:	1040000a 	beqz	v0,80338c <main+0x8c>
  803364:	00000000 	nop
  803368:	3c020080 	lui	v0,0x80
  80336c:	244438e8 	addiu	a0,v0,14568
  803370:	24050017 	li	a1,23
  803374:	3c020080 	lui	v0,0x80
  803378:	244638f8 	addiu	a2,v0,14584
  80337c:	3c020080 	lui	v0,0x80
  803380:	24473910 	addiu	a3,v0,14608
  803384:	0c200254 	jal	800950 <__panic>
  803388:	00000000 	nop
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  80338c:	0c2005e6 	jal	801798 <gettime_msec>
  803390:	00000000 	nop
  803394:	00401821 	move	v1,v0
  803398:	8fc20018 	lw	v0,24(s8)
  80339c:	00621023 	subu	v0,v1,v0
  8033a0:	3c030080 	lui	v1,0x80
  8033a4:	24643944 	addiu	a0,v1,14660
  8033a8:	00402821 	move	a1,v0
  8033ac:	0c2002bd 	jal	800af4 <cprintf>
  8033b0:	00000000 	nop
    cprintf("sleep pass.\n");
  8033b4:	3c020080 	lui	v0,0x80
  8033b8:	24443958 	addiu	a0,v0,14680
  8033bc:	0c2002bd 	jal	800af4 <cprintf>
  8033c0:	00000000 	nop
    return 0;
  8033c4:	00001021 	move	v0,zero
}
  8033c8:	03c0e821 	move	sp,s8
  8033cc:	8fbf002c 	lw	ra,44(sp)
  8033d0:	8fbe0028 	lw	s8,40(sp)
  8033d4:	27bd0030 	addiu	sp,sp,48
  8033d8:	03e00008 	jr	ra
  8033dc:	00000000 	nop
