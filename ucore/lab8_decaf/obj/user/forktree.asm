...
obj/__user_forktree.out:     file format elf32-tradlittlemips
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8004ec:	244433f0 	addiu	a0,v0,13296
  ...
  800510:	246433fc 	addiu	a0,v1,13308
  ...
  80052c:	24643410 	addiu	a0,v1,13328
  ...
  800548:	24643424 	addiu	a0,v1,13348
  ...
  800564:	24643438 	addiu	a0,v1,13368
...
void _PrintInt(int x) {
  ...
  8006f0:	24443450 	addiu	a0,v0,13392
...
void _PrintChar(char x) {
  ...
  800738:	24643454 	addiu	a0,v1,13396
...
void _PrintString(const char* x) {
  ...
  800778:	24443458 	addiu	a0,v0,13400
...
void _PrintBool(bool x) {
  ...
  8007c4:	2444345c 	addiu	a0,v0,13404
  ...
  8007dc:	24443464 	addiu	a0,v0,13412
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80097c:	24443470 	addiu	a0,v0,13424
  ...
  8009a8:	2444348c 	addiu	a0,v0,13452
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8009ec:	24443490 	addiu	a0,v0,13456
  ...
  800a18:	2444348c 	addiu	a0,v0,13452
...
readline(const char *prompt) {
  ...
  800d3c:	244534b0 	addiu	a1,v0,13488
  ...
  800e0c:	246534b4 	addiu	a1,v1,13492
  ...
  800e6c:	246534b4 	addiu	a1,v1,13492
  ...
  800ebc:	246534b4 	addiu	a1,v1,13492
...
exit(int error_code) {
  ...
  8015a4:	244434c0 	addiu	a0,v0,13504
...
umain(int argc, char *argv[]) {
  ...
  801940:	244534e0 	addiu	a1,v0,13536
  ...
  801964:	244434e8 	addiu	a0,v0,13544
  801968:	2405001a 	li	a1,26
  80196c:	3c020080 	lui	v0,0x80
  801970:	244634fc 	addiu	a2,v0,13564
  ...
  801988:	24453518 	addiu	a1,v0,13592
  ...
  8019ac:	244434e8 	addiu	a0,v0,13544
  8019b0:	2405001d 	li	a1,29
  8019b4:	3c020080 	lui	v0,0x80
  8019b8:	24463520 	addiu	a2,v0,13600
  ...
  8019d0:	0c200ce5 	jal	803394 <main>
  8019d4:	00000000 	nop
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  801d74:	24433750 	addiu	v1,v0,14160
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  802088:	2442377c 	addiu	v0,v0,14204
  ...
  80220c:	244236ec 	addiu	v0,v0,14060
  ...
  802234:	24473764 	addiu	a3,v0,14180
  ...
  80225c:	24473770 	addiu	a3,v0,14192
  ...
  80228c:	24513774 	addiu	s1,v0,14196
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  803294:	00a01021 	move	v0,a1
  803298:	a3c20034 	sb	v0,52(s8)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  80329c:	8fc40030 	lw	a0,48(s8)
  8032a0:	0c200a34 	jal	8028d0 <strlen>
  8032a4:	00000000 	nop
  8032a8:	2c420004 	sltiu	v0,v0,4
  8032ac:	10400018 	beqz	v0,803310 <forkchild+0x90>
  8032b0:	00000000 	nop
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  8032b4:	83c20034 	lb	v0,52(s8)
  8032b8:	afa20010 	sw	v0,16(sp)
  8032bc:	27c20020 	addiu	v0,s8,32
  8032c0:	00402021 	move	a0,v0
  8032c4:	24050005 	li	a1,5
  8032c8:	3c020080 	lui	v0,0x80
  8032cc:	244638e0 	addiu	a2,v0,14560
  8032d0:	8fc70030 	lw	a3,48(s8)
  8032d4:	0c2009bf 	jal	8026fc <snprintf>
  8032d8:	00000000 	nop
    if (fork() == 0) {
  8032dc:	0c20056e 	jal	8015b8 <fork>
  8032e0:	00000000 	nop
  8032e4:	1440000a 	bnez	v0,803310 <forkchild+0x90>
  8032e8:	00000000 	nop
        forktree(nxt);
  8032ec:	27c20020 	addiu	v0,s8,32
  8032f0:	00402021 	move	a0,v0
  8032f4:	0c200cca 	jal	803328 <forktree>
  8032f8:	00000000 	nop
        yield();
  8032fc:	0c200598 	jal	801660 <yield>
  803300:	00000000 	nop
        exit(0);
  803304:	00002021 	move	a0,zero
  803308:	0c200560 	jal	801580 <exit>
  80330c:	00000000 	nop
    }
}
  803310:	03c0e821 	move	sp,s8
  803314:	8fbf002c 	lw	ra,44(sp)
  803318:	8fbe0028 	lw	s8,40(sp)
  80331c:	27bd0030 	addiu	sp,sp,48
  803320:	03e00008 	jr	ra
  803324:	00000000 	nop
...
forktree(const char *cur) {
  803328:	27bdffe0 	addiu	sp,sp,-32
  80332c:	afbf001c 	sw	ra,28(sp)
  803330:	afbe0018 	sw	s8,24(sp)
  803334:	03a0f021 	move	s8,sp
  803338:	afc40020 	sw	a0,32(s8)
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  80333c:	0c2005b2 	jal	8016c8 <getpid>
  803340:	00000000 	nop
  803344:	3c030080 	lui	v1,0x80
  803348:	246438e8 	addiu	a0,v1,14568
  80334c:	00402821 	move	a1,v0
  803350:	8fc60020 	lw	a2,32(s8)
  803354:	0c2002bd 	jal	800af4 <cprintf>
  803358:	00000000 	nop

    forkchild(cur, '0');
  80335c:	8fc40020 	lw	a0,32(s8)
  803360:	24050030 	li	a1,48
  803364:	0c200ca0 	jal	803280 <forkchild>
  803368:	00000000 	nop
    forkchild(cur, '1');
  80336c:	8fc40020 	lw	a0,32(s8)
  803370:	24050031 	li	a1,49
  803374:	0c200ca0 	jal	803280 <forkchild>
  803378:	00000000 	nop
}
  80337c:	03c0e821 	move	sp,s8
  803380:	8fbf001c 	lw	ra,28(sp)
  803384:	8fbe0018 	lw	s8,24(sp)
  803388:	27bd0020 	addiu	sp,sp,32
  80338c:	03e00008 	jr	ra
  803390:	00000000 	nop
...
int
main(void) {
  803394:	27bdffe0 	addiu	sp,sp,-32
  803398:	afbf001c 	sw	ra,28(sp)
  80339c:	afbe0018 	sw	s8,24(sp)
  8033a0:	03a0f021 	move	s8,sp
    cprintf("forktree process will sleep %d ticks\n",SLEEP_TIME);
  8033a4:	3c020080 	lui	v0,0x80
  8033a8:	244438fc 	addiu	a0,v0,14588
  8033ac:	24050190 	li	a1,400
  8033b0:	0c2002bd 	jal	800af4 <cprintf>
  8033b4:	00000000 	nop
    sleep(SLEEP_TIME);
  8033b8:	24040190 	li	a0,400
  8033bc:	0c2005d8 	jal	801760 <sleep>
  8033c0:	00000000 	nop
    forktree("");
  8033c4:	3c020080 	lui	v0,0x80
  8033c8:	24443924 	addiu	a0,v0,14628
  8033cc:	0c200cca 	jal	803328 <forktree>
  8033d0:	00000000 	nop
    return 0;
  8033d4:	00001021 	move	v0,zero
}
  8033d8:	03c0e821 	move	sp,s8
  8033dc:	8fbf001c 	lw	ra,28(sp)
  8033e0:	8fbe0018 	lw	s8,24(sp)
  8033e4:	27bd0020 	addiu	sp,sp,32
  8033e8:	03e00008 	jr	ra
  8033ec:	00000000 	nop
