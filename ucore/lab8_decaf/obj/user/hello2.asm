...
obj/__user_hello2.out:     file format elf32-tradlittlemips
...
main:                                   # function entry
  ...
  803280:	27bdfffc afbe0000 afbffffc 03a0f021     ...'........!...
          ...
          move $fp, $sp                 
          addiu $sp, $sp, -28           
  803290:	27bdffe4 afc40004 afc50008 afc6000c     ...'............
          sw $a0, 4($fp)                
          sw $a1, 8($fp)                
          sw $a2, 12($fp)               
          sw $a3, 16($fp)               
...
_L12:                                   
  ...
  8032a8:	25084030 	addiu	t0,t0,16432
          la      $t0, _STRING0         
  8032ac:	3c080080 	lui	t0,0x80
  8032b0:	25084030 	addiu	t0,t0,16432
          move    $a0, $t0              
  8032b4:	01002021 	move	a0,t0
          jal     _PrintString          
  8032b8:	0c2001d8 	jal	800760 <_PrintString>
  8032bc:	00000000 	nop
          move    $v0, $zero            
  8032c0:	00001021 	move	v0,zero
          move    $sp, $fp              
  8032c4:	03c0e821 	move	sp,s8
          lw      $ra, -4($fp)          
  8032c8:	8fdffffc 	lw	ra,-4(s8)
          lw      $fp, 0($fp)           
  8032cc:	8fde0000 	lw	s8,0(s8)
          addu    $sp, $sp, 4           
  8032d0:	27bd0004 	addiu	sp,sp,4
          jr      $ra                   
  8032d4:	03e00008 	jr	ra
  8032d8:	00000000 	nop
  8032dc:	00000000 	nop
