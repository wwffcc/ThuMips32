...
obj/__user_forktest.out:     file format elf32-tradlittlemips
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8004ec:	24443400 	addiu	a0,v0,13312
  ...
  800510:	2464340c 	addiu	a0,v1,13324
  ...
  80052c:	24643420 	addiu	a0,v1,13344
  ...
  800548:	24643434 	addiu	a0,v1,13364
  ...
  800564:	24643448 	addiu	a0,v1,13384
...
void _PrintInt(int x) {
  ...
  8006f0:	24443460 	addiu	a0,v0,13408
...
void _PrintChar(char x) {
  ...
  800738:	24643464 	addiu	a0,v1,13412
...
void _PrintString(const char* x) {
  ...
  800778:	24443468 	addiu	a0,v0,13416
...
void _PrintBool(bool x) {
  ...
  8007c4:	2444346c 	addiu	a0,v0,13420
  ...
  8007dc:	24443474 	addiu	a0,v0,13428
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80097c:	24443480 	addiu	a0,v0,13440
  ...
  8009a8:	2444349c 	addiu	a0,v0,13468
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8009ec:	244434a0 	addiu	a0,v0,13472
  ...
  800a18:	2444349c 	addiu	a0,v0,13468
...
readline(const char *prompt) {
  ...
  800d3c:	244534c0 	addiu	a1,v0,13504
  ...
  800e0c:	246534c4 	addiu	a1,v1,13508
  ...
  800e6c:	246534c4 	addiu	a1,v1,13508
  ...
  800ebc:	246534c4 	addiu	a1,v1,13508
...
exit(int error_code) {
  ...
  8015a4:	244434d0 	addiu	a0,v0,13520
...
umain(int argc, char *argv[]) {
  ...
  801940:	244534f0 	addiu	a1,v0,13552
  ...
  801964:	244434f8 	addiu	a0,v0,13560
  801968:	2405001a 	li	a1,26
  80196c:	3c020080 	lui	v0,0x80
  801970:	2446350c 	addiu	a2,v0,13580
  ...
  801988:	24453528 	addiu	a1,v0,13608
  ...
  8019ac:	244434f8 	addiu	a0,v0,13560
  8019b0:	2405001d 	li	a1,29
  8019b4:	3c020080 	lui	v0,0x80
  8019b8:	24463530 	addiu	a2,v0,13616
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  801d74:	24433760 	addiu	v1,v0,14176
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  802088:	2442378c 	addiu	v0,v0,14220
  ...
  80220c:	244236fc 	addiu	v0,v0,14076
  ...
  802234:	24473774 	addiu	a3,v0,14196
  ...
  80225c:	24473780 	addiu	a3,v0,14208
  ...
  80228c:	24513784 	addiu	s1,v0,14212
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  803290:	afc00018 	sw	zero,24(s8)
  803294:	08200cc4 	j	803310 <main+0x90>
  803298:	00000000 	nop
        if ((pid = fork()) == 0) {
  80329c:	0c20056e 	jal	8015b8 <fork>
  8032a0:	00000000 	nop
  8032a4:	afc2001c 	sw	v0,28(s8)
  8032a8:	8fc2001c 	lw	v0,28(s8)
  8032ac:	14400009 	bnez	v0,8032d4 <main+0x54>
  8032b0:	00000000 	nop
            cprintf("I am child %d\n", n);
  8032b4:	3c020080 	lui	v0,0x80
  8032b8:	244438f4 	addiu	a0,v0,14580
  8032bc:	8fc50018 	lw	a1,24(s8)
  8032c0:	0c2002bd 	jal	800af4 <cprintf>
  8032c4:	00000000 	nop
            exit(0);
  8032c8:	00002021 	move	a0,zero
  8032cc:	0c200560 	jal	801580 <exit>
  8032d0:	00000000 	nop
        }
        assert(pid > 0);
  8032d4:	8fc2001c 	lw	v0,28(s8)
  8032d8:	1c40000a 	bgtz	v0,803304 <main+0x84>
  8032dc:	00000000 	nop
  8032e0:	3c020080 	lui	v0,0x80
  8032e4:	24443904 	addiu	a0,v0,14596
  8032e8:	2405000e 	li	a1,14
  8032ec:	3c020080 	lui	v0,0x80
  8032f0:	24463914 	addiu	a2,v0,14612
  8032f4:	3c020080 	lui	v0,0x80
  8032f8:	2447392c 	addiu	a3,v0,14636
  8032fc:	0c200254 	jal	800950 <__panic>
  803300:	00000000 	nop
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  803304:	8fc20018 	lw	v0,24(s8)
  803308:	24420001 	addiu	v0,v0,1
  80330c:	afc20018 	sw	v0,24(s8)
  803310:	24020020 	li	v0,32
  803314:	8fc30018 	lw	v1,24(s8)
  803318:	0062102a 	slt	v0,v1,v0
  80331c:	1440ffdf 	bnez	v0,80329c <main+0x1c>
  803320:	00000000 	nop
            exit(0);
        }
        assert(pid > 0);
    ...
    if (n > max_child) {
  803324:	24020020 	li	v0,32
  803328:	8fc30018 	lw	v1,24(s8)
  80332c:	0043102a 	slt	v0,v0,v1
  803330:	10400009 	beqz	v0,803358 <main+0xd8>
  803334:	00000000 	nop
        panic("fork claimed to work %d times!\n", n);
  803338:	3c020080 	lui	v0,0x80
  80333c:	24443904 	addiu	a0,v0,14596
  803340:	24050012 	li	a1,18
  803344:	3c020080 	lui	v0,0x80
  803348:	24463934 	addiu	a2,v0,14644
  80334c:	8fc70018 	lw	a3,24(s8)
  803350:	0c200254 	jal	800950 <__panic>
  803354:	00000000 	nop
    }

    for (; n > 0; n --) {
  803358:	08200ce6 	j	803398 <main+0x118>
  80335c:	00000000 	nop
        if (wait() != 0) {
  803360:	0c20057a 	jal	8015e8 <wait>
  803364:	00000000 	nop
  803368:	10400008 	beqz	v0,80338c <main+0x10c>
  80336c:	00000000 	nop
            panic("wait stopped early\n");
  803370:	3c020080 	lui	v0,0x80
  803374:	24443904 	addiu	a0,v0,14596
  803378:	24050017 	li	a1,23
  80337c:	3c020080 	lui	v0,0x80
  803380:	24463954 	addiu	a2,v0,14676
  803384:	0c200254 	jal	800950 <__panic>
  803388:	00000000 	nop
    ...
    for (; n > 0; n --) {
  80338c:	8fc20018 	lw	v0,24(s8)
  803390:	2442ffff 	addiu	v0,v0,-1
  803394:	afc20018 	sw	v0,24(s8)
  803398:	8fc20018 	lw	v0,24(s8)
  80339c:	1c40fff0 	bgtz	v0,803360 <main+0xe0>
  8033a0:	00000000 	nop
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    ...
    if (wait() == 0) {
  8033a4:	0c20057a 	jal	8015e8 <wait>
  8033a8:	00000000 	nop
  8033ac:	14400008 	bnez	v0,8033d0 <main+0x150>
  8033b0:	00000000 	nop
        panic("wait got too many\n");
  8033b4:	3c020080 	lui	v0,0x80
  8033b8:	24443904 	addiu	a0,v0,14596
  8033bc:	2405001c 	li	a1,28
  8033c0:	3c020080 	lui	v0,0x80
  8033c4:	24463968 	addiu	a2,v0,14696
  8033c8:	0c200254 	jal	800950 <__panic>
  8033cc:	00000000 	nop
    }

    cprintf("forktest pass.\n");
  8033d0:	3c020080 	lui	v0,0x80
  8033d4:	2444397c 	addiu	a0,v0,14716
  8033d8:	0c2002bd 	jal	800af4 <cprintf>
  8033dc:	00000000 	nop
    return 0;
  8033e0:	00001021 	move	v0,zero
}
  8033e4:	03c0e821 	move	sp,s8
  8033e8:	8fbf0024 	lw	ra,36(sp)
  8033ec:	8fbe0020 	lw	s8,32(sp)
  8033f0:	27bd0028 	addiu	sp,sp,40
  8033f4:	03e00008 	jr	ra
  8033f8:	00000000 	nop
  8033fc:	00000000 	nop
