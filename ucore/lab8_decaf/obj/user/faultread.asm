...
obj/__user_faultread.out:     file format elf32-tradlittlemips
...
main(void) {
  ...
  8032b0:	244437d4 	addiu	a0,v0,14292
  8032b4:	24050007 	li	a1,7
  8032b8:	3c020080 	lui	v0,0x80
  8032bc:	244637e8 	addiu	a2,v0,14312
