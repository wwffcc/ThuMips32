...
obj/__user_hello.out:     file format elf32-tradlittlemips
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8004ec:	244432f0 	addiu	a0,v0,13040
  ...
  800510:	246432fc 	addiu	a0,v1,13052
  ...
  80052c:	24643310 	addiu	a0,v1,13072
  ...
  800548:	24643324 	addiu	a0,v1,13092
  ...
  800564:	24643338 	addiu	a0,v1,13112
...
void _PrintInt(int x) {
  ...
  8006f0:	24443350 	addiu	a0,v0,13136
...
void _PrintChar(char x) {
  ...
  800738:	24643354 	addiu	a0,v1,13140
...
void _PrintString(const char* x) {
  ...
  800778:	24443358 	addiu	a0,v0,13144
...
void _PrintBool(bool x) {
  ...
  8007c4:	2444335c 	addiu	a0,v0,13148
  ...
  8007dc:	24443364 	addiu	a0,v0,13156
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80097c:	24443370 	addiu	a0,v0,13168
  ...
  8009a8:	2444338c 	addiu	a0,v0,13196
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8009ec:	24443390 	addiu	a0,v0,13200
  ...
  800a18:	2444338c 	addiu	a0,v0,13196
...
readline(const char *prompt) {
  ...
  800d3c:	244533b0 	addiu	a1,v0,13232
  ...
  800e0c:	246533b4 	addiu	a1,v1,13236
  ...
  800e6c:	246533b4 	addiu	a1,v1,13236
  ...
  800ebc:	246533b4 	addiu	a1,v1,13236
...
exit(int error_code) {
  ...
  8015a4:	244433c0 	addiu	a0,v0,13248
...
umain(int argc, char *argv[]) {
  ...
  801940:	244533e0 	addiu	a1,v0,13280
  ...
  801964:	244433e8 	addiu	a0,v0,13288
  801968:	2405001a 	li	a1,26
  80196c:	3c020080 	lui	v0,0x80
  801970:	244633fc 	addiu	a2,v0,13308
  ...
  801988:	24453418 	addiu	a1,v0,13336
  ...
  8019ac:	244433e8 	addiu	a0,v0,13288
  8019b0:	2405001d 	li	a1,29
  8019b4:	3c020080 	lui	v0,0x80
  8019b8:	24463420 	addiu	a2,v0,13344
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  801d74:	24433650 	addiu	v1,v0,13904
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  802088:	2442367c 	addiu	v0,v0,13948
  ...
  80220c:	244235ec 	addiu	v0,v0,13804
  ...
  802234:	24473664 	addiu	a3,v0,13924
  ...
  80225c:	24473670 	addiu	a3,v0,13936
  ...
  80228c:	24513674 	addiu	s1,v0,13940
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  803294:	244437e0 	addiu	a0,v0,14304
  803298:	0c2002bd 	jal	800af4 <cprintf>
  80329c:	00000000 	nop
    cprintf("I am process %d.\n", getpid());
  8032a0:	0c2005b2 	jal	8016c8 <getpid>
  8032a4:	00000000 	nop
  8032a8:	3c030080 	lui	v1,0x80
  8032ac:	246437f0 	addiu	a0,v1,14320
  8032b0:	00402821 	move	a1,v0
  8032b4:	0c2002bd 	jal	800af4 <cprintf>
  8032b8:	00000000 	nop
    cprintf("hello pass.\n");
  8032bc:	3c020080 	lui	v0,0x80
  8032c0:	24443804 	addiu	a0,v0,14340
  8032c4:	0c2002bd 	jal	800af4 <cprintf>
  8032c8:	00000000 	nop
    return 0;
  8032cc:	00001021 	move	v0,zero
}
  8032d0:	03c0e821 	move	sp,s8
  8032d4:	8fbf001c 	lw	ra,28(sp)
  8032d8:	8fbe0018 	lw	s8,24(sp)
  8032dc:	27bd0020 	addiu	sp,sp,32
  8032e0:	03e00008 	jr	ra
  8032e4:	00000000 	nop
	...
